...
export const MODEL_HELP_BY_PROVIDER: Record<RuntimeProvider, string> = {
  ...
  antigravity:
    "Options come from this computer's Antigravity CLI (`agy models`) when reachable. The slug is passed through verbatim on the next turn — one your account can't use fails visibly, no silent fallback. Unset uses the local Antigravity default.",
  "kimi-code":
